...
import (
	...
	"gitlab.com/meta-node/meta-node/pkg/test_structs"
...
func TestAddVote(t *testing.T) {
	addressess := map[common.Address][]network.IConnection{
		testAddress1: {&test_structs.TestConnection{}},
		testAddress3: {&test_structs.TestConnection{}},
	}
	votePool := NewVotePool(2.0/3.0, network.MapAddressConnectionsToInterface(addressess))
